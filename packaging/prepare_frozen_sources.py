...
from chess_camera_app.runtime.runtime_multi_move_patch import apply_source_patches
...
def main() -> Path:
    """Write the core app with reliability and multi-move patches at build time."""
    source = (ROOT / "chess_camera_app" / "core" / "app.py").read_text(
        encoding="utf-8"
    )
